...
async def get_user_by_id(user_id: str) -> str:
    return await user_client.get_user(int(user_id))


@mcp.tool()
async def delete_user(user_id: str) -> str:
    return await user_client.delete_user(int(user_id))


@mcp.tool()
async def search_user(name: str, surname: str, email: str, gender: str) -> str:
...
@mcp.prompt("search-helper", description="Helps users formulate effective search queries.")
async def search_helper() -> str:
    return """
...
@mcp.prompt("creation-helper", description="Guides creation of realistic user profiles.")
async def creation_helper() -> str:
    return """
