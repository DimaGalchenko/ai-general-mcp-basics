...
class MCPClient:
    ...
    async def __aenter__(self):
        ...
        print("MCP Server capabilities:", result)
        return self
    ...
    async def get_resources(self) -> list[Resource]:
        ...
        try:
            ...
            print(f"Error while fetching resources: {e}")
            return []
    ...
    async def get_resource(self, uri: AnyUrl) -> str:
        ...
        resource_response = await self.session.read_resource(uri)
